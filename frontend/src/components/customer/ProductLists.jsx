...
import { getProductList } from "../../services/productService";
import { getCategoryList } from "../../services/categoryService";
import { FilterIcon, Plug2Icon, PlusSquare, SortDescIcon } from "lucide-react";
...
// This component should be placed where you need the filter/sort bar
const FilterSortBar = ({ toggleFilterSidebar, toggleSortModal }) => {
    ...
    return (
        <div
            ...
            style={{ bottom: "25px" }} // Adjust to match your navbar height
        >
