...
// import { Calendar, ArrowDownCircle, ArrowUpCircle, Filter, ChevronLeft, ChevronRight, Search, Info, Wallet as WalletIcon } from 'lucide-react';
...
//                 page: currentPage,
//                 limit: 4 // Same as transactionsPerPage in your original code
//             });
...
//                             <button className="bg-black text-white px-4 py-2 rounded-lg text-sm mr-3 hover:bg-gray-800 transition-colors duration-200">
//                                 Add Money
//                             </button>
