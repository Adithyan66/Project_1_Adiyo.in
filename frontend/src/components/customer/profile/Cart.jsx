...
const Cart = () => {
    ...
    return (
        <div className="flex-1 p-3 sm:p-6 bg-white m-2 sm:m-6 rounded-md min-h-[800px]">
            ...
            {/* Cart Content - Side by side only on very large screens */}
            <div className="flex flex-col xl:flex-row">
                {/* Cart Items */}
                <div className="flex-grow p-3 sm:p-6 overflow-y-auto">
                    {cartItems.length > 0 ? (
                        <div>
                            {/* Table Header - only for XL screens */}
                            <div className="hidden xl:grid grid-cols-12 gap-4 border-b border-gray-200 pb-4 text-gray-500 font-medium">
                                <div className="col-span-6">Product</div>
                                <div className="col-span-2 text-center">Price</div>
                                <div className="col-span-2 text-center">Quantity</div>
                                <div className="col-span-2 text-right">Total</div>
                            ...
                            {cartItems.map(item => {
                                ...
                                return (
                                    <div key={item._id} className="mb-6 border-b border-gray-200 pb-6">
                                        <div className="flex flex-col sm:flex-row">
                                            {/* Product Image & Basic Info - Left side */}
                                            <div className="flex flex-row sm:w-1/2">
                                                <div className="w-1/3 sm:w-1/4 h-auto min-h-[120px]">
                                                    {productImage ? (
                                                        <img
                                                            src={productImage}
                                                            alt={item.product.name}
                                                ...
                                                <div className="flex flex-col justify-between py-2 pl-4 w-2/3 sm:w-3/4">
                                                    <div>
                                                        <h3 className="font-medium text-base sm:text-lg truncate">{item.product.name}</h3>
                                            ...
                                            {/* Price, Quantity, Total - Right side */}
                                            <div className="flex sm:w-1/2 mt-4 sm:mt-0">
                                                <div className="flex flex-row w-full justify-between sm:justify-end items-center">
                                                    ...
                                                    <div className="sm:w-1/3 text-center">
                                                        ...
                                                        <div className="flex flex-col items-center">
                                                            <span className="text-gray-500 line-through text-xs sm:text-sm">₹{basePrice.toFixed(2)}</span>
                                                            <span className="font-medium text-sm sm:text-base">₹{discountPrice.toFixed(2)}</span>
                                                    ...
                                                    {/* Quantity */}
                                                    <div className="sm:w-1/3 text-center">
                                                        <div className="text-xs sm:text-sm text-gray-500 mb-1">Quantity</div>
                                                        <div className="flex items-center justify-center border rounded-md w-24">
                                                            <button
                                                                onClick={() => updateQuantity(item._id, -1)}
                ...
                {/* Order Summary - Full width on mobile/tablet/laptop, side panel only on XL screens */}
                {cartItems.length > 0 && (
                    <div className="xl:w-80 w-full flex-shrink-0 bg-gray-50 p-4 sm:p-6 mt-4 rounded-md">
                        <h3 className="text-lg sm:text-xl font-medium mb-4 sm:mb-6">Order Summary</h3>
