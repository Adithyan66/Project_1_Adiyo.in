...
// export function NavButtons({ onUserClick, mobileView = false }) {

//   const navigate = useNavigate()

//   return (
//     <div className={`flex items-center ${mobileView ? "space-x-3" : "space-x-6 ml-[30px]"}`}>
//       <button
//         onClick={() => navigate("/user/view-cart")}
//         className={`${mobileView ? "p-1" : "p-2"} rounded-full hover:bg-gray-100`}>
//         <svg
//           className={`${mobileView ? "w-5 h-5" : "w-6 h-6"}`}
...
//       <button
//         onClick={onUserClick}
//         className={`${mobileView ? "p-1" : "p-2"} rounded-full hover:bg-gray-100 relative`}
//       >
//         <svg
//           className={`${mobileView ? "w-5 h-5" : "w-6 h-6"}`}
//           xmlns="http://www.w3.org/2000/svg"
...
export function NavButtons({ onUserClick, isOpen = false, mobileView = false }) {
  const navigate = useNavigate();
