...
function Footer() {
    return (
        <footer className="bg-gray-200 text-gray-700 py-8">
            <div className="max-w-7xl mx-auto px-4">
                {/* Top Section: Grid Layout - Hidden on mobile */}
                ...
                {/* Bottom Section: Copyright + Payment Icons - Shown on all screens */}
                <div className="flex flex-col md:flex-row items-center justify-between md:border-t md:border-gray-300 md:pt-4 md:mt-8">
                    <p className="text-sm text-gray-500 text-center md:text-left mb-4 md:mb-0">
                        Adiyo.in © 2020-2021. All Rights Reserved
                    </p>
                    <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4">
                        <img src={visa} alt="Visa" className="h-8 md:h-10 w-auto" />
                        <img src={mastercard} alt="MasterCard" className="h-8 md:h-10 w-auto" />
                        <img src={paypal} alt="PayPal" className="h-8 md:h-10 w-auto" />
                        <img src={applepay} alt="Apple Pay" className="h-8 md:h-10 w-auto" />
                        <img src={gpay} alt="Google Pay" className="h-8 md:h-10 w-auto" />
                    </div>
                </div>
            </div>
        </footer>
