...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside
                id="sidebar"
                className={`fixed inset-y-0 left-0 w-92 bg-white shadow-lg border-r border-gray-100 transition-transform duration-300 md:sticky md:top-0 md:h-screen  md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    } z-40`}
            >
