...
const orderSchema = new mongoose.Schema({
    ...
    paymentMethod: {
        type: String,
        required: true,
        enum: ["wallet", "upi", "netbanking", "cod", "paypal", "razorpay"]
    },
    paymentStatus: {
        type: String,
        required: true,
    ...
    orderStatus: {
        type: String,
        required: true,
        enum: ["failed", "placed", "processing", "shipped", "delivered", "cancelled", "returned", "pending", "out for delivery", "return requested"],
        default: "placed"
    },
    trackingNumber: {
        type: String
